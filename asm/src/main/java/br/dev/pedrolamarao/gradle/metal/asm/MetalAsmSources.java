...
public class MetalAsmSources implements Named
{
    ...
    private final TaskProvider<AsmCompileTask> compileTask;
    ...
    @Inject
    public MetalAsmSources (ListProperty<String> compileOptions, TaskProvider<AsmCompileTask> compileTask, ConfigurableFileCollection headers, String name, SourceDirectorySet sources)
    {
